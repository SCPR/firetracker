...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WildfireTweet.twitter_hashtag'
        db.delete_column('calfire_tracker_wildfiretweet', 'twitter_hashtag_id')

        # Adding field 'WildfireTweet.tweet_hashtag'
        db.add_column('calfire_tracker_wildfiretweet', 'tweet_hashtag',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WildfireTweet.twitter_hashtag'
        db.add_column('calfire_tracker_wildfiretweet', 'twitter_hashtag',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calwildfire_twitter_hashtag', null=True, to=orm['calfire_tracker.CalWildfire'], blank=True),
                      keep_default=False)

        # Deleting field 'WildfireTweet.tweet_hashtag'
        db.delete_column('calfire_tracker_wildfiretweet', 'tweet_hashtag')
