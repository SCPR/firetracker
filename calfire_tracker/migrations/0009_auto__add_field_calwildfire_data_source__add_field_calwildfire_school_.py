...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.data_source'
        db.add_column('calfire_tracker_calwildfire', 'data_source',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CalWildfire.school_closures'
        db.add_column('calfire_tracker_calwildfire', 'school_closures',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.data_source'
        db.delete_column('calfire_tracker_calwildfire', 'data_source')

        # Deleting field 'CalWildfire.school_closures'
        db.delete_column('calfire_tracker_calwildfire', 'school_closures')
