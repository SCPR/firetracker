...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.computed_location'
        db.add_column('calfire_tracker_calwildfire', 'computed_location',
    ...
    def backwards(self, orm):
        # Deleting field 'CalWildfire.computed_location'
        db.delete_column('calfire_tracker_calwildfire', 'computed_location')


        # Changing field 'CalWildfire.location'
        db.alter_column('calfire_tracker_calwildfire', 'location', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
    ...
    models = {
        'calfire_tracker.calwildfire': {
            ...
            'computed_location': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'location': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
