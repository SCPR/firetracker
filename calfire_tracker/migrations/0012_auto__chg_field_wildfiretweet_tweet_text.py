...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WildfireTweet.tweet_text'
        db.alter_column('calfire_tracker_wildfiretweet', 'tweet_text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'WildfireTweet.tweet_text'
        db.alter_column('calfire_tracker_wildfiretweet', 'tweet_text', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
