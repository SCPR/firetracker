...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.update_lockout'
        db.add_column('calfire_tracker_calwildfire', 'update_lockout',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.update_lockout'
        db.delete_column('calfire_tracker_calwildfire', 'update_lockout')
