...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field wildfire_updates on 'CalWildfire'
        db.create_table('calfire_tracker_calwildfire_wildfire_updates', (
        ...
        db.create_unique('calfire_tracker_calwildfire_wildfire_updates', ['calwildfire_id', 'wildfireupdate_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field wildfire_updates on 'CalWildfire'
        db.delete_table('calfire_tracker_calwildfire_wildfire_updates')
    ...
    models = {
        'calfire_tracker.calwildfire': {
            ...
            'wildfire_updates': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['calfire_tracker.WildfireUpdate']", 'null': 'True', 'blank': 'True'})
        },
