...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.historical_narrative'
        db.add_column('calfire_tracker_calwildfire', 'historical_narrative',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.historical_narrative'
        db.delete_column('calfire_tracker_calwildfire', 'historical_narrative')
