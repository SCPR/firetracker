...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalWildfire.wildfire_update'
        db.delete_column('calfire_tracker_calwildfire', 'wildfire_update_id')

        # Adding M2M table for field wildfire_update on 'CalWildfire'
        db.create_table('calfire_tracker_calwildfire_wildfire_update', (
        ...
        db.create_unique('calfire_tracker_calwildfire_wildfire_update', ['calwildfire_id', 'wildfireupdate_id'])


    def backwards(self, orm):
        # Adding field 'CalWildfire.wildfire_update'
        db.add_column('calfire_tracker_calwildfire', 'wildfire_update',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calfire_tracker.WildfireUpdate'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field wildfire_update on 'CalWildfire'
        db.delete_table('calfire_tracker_calwildfire_wildfire_update')
    ...
    models = {
        'calfire_tracker.calwildfire': {
            ...
            'wildfire_update': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['calfire_tracker.WildfireUpdate']", 'null': 'True', 'blank': 'True'})
        },
