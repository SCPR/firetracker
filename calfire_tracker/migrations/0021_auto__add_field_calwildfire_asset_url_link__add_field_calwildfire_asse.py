...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.asset_url_link'
        db.add_column('calfire_tracker_calwildfire', 'asset_url_link',
                      self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CalWildfire.asset_photo_credit'
        db.add_column('calfire_tracker_calwildfire', 'asset_photo_credit',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.asset_url_link'
        db.delete_column('calfire_tracker_calwildfire', 'asset_url_link')

        # Deleting field 'CalWildfire.asset_photo_credit'
        db.delete_column('calfire_tracker_calwildfire', 'asset_photo_credit')
