...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WildfireSource.data_paginated'
        db.add_column('calfire_tracker_wildfiresource', 'data_paginated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WildfireSource.number_of_pages'
        db.add_column('calfire_tracker_wildfiresource', 'number_of_pages',
                      self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WildfireSource.data_paginated'
        db.delete_column('calfire_tracker_wildfiresource', 'data_paginated')

        # Deleting field 'WildfireSource.number_of_pages'
        db.delete_column('calfire_tracker_wildfiresource', 'number_of_pages')
