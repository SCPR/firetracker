...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.fire_slug'
        db.add_column('calfire_tracker_calwildfire', 'fire_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.fire_slug'
        db.delete_column('calfire_tracker_calwildfire', 'fire_slug')
