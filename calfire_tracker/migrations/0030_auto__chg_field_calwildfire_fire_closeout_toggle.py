...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalWildfire.fire_closeout_toggle'
        db.alter_column('calfire_tracker_calwildfire', 'fire_closeout_toggle', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'CalWildfire.fire_closeout_toggle'
        db.alter_column('calfire_tracker_calwildfire', 'fire_closeout_toggle', self.gf('django.db.models.fields.NullBooleanField')(null=True))
