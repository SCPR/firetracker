...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.fire_closeout_toggle'
        db.add_column('calfire_tracker_calwildfire', 'fire_closeout_toggle',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.fire_closeout_toggle'
        db.delete_column('calfire_tracker_calwildfire', 'fire_closeout_toggle')
    ...
    models = {
        'calfire_tracker.calwildfire': {
            ...
            'fire_closeout_toggle': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
