...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalWildfire.date_time_started'
        db.alter_column('calfire_tracker_calwildfire', 'date_time_started', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CalWildfire.date_time_started'
        db.alter_column('calfire_tracker_calwildfire', 'date_time_started', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
