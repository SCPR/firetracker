...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WildfireDisplayContent.resource_content_type'
        db.add_column('calfire_tracker_wildfiredisplaycontent', 'resource_content_type',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WildfireDisplayContent.display_content_type'
        db.add_column('calfire_tracker_wildfiredisplaycontent', 'display_content_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WildfireDisplayContent.resource_content_type'
        db.delete_column('calfire_tracker_wildfiredisplaycontent', 'resource_content_type')

        # Deleting field 'WildfireDisplayContent.display_content_type'
        db.delete_column('calfire_tracker_wildfiredisplaycontent', 'display_content_type')
