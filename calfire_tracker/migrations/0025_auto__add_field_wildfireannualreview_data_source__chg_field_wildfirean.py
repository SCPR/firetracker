...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WildfireAnnualReview.data_source'
        db.add_column('calfire_tracker_wildfireannualreview', 'data_source',
                      self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


        # Changing field 'WildfireAnnualReview.date_range_beginning'
        db.alter_column('calfire_tracker_wildfireannualreview', 'date_range_beginning', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'WildfireAnnualReview.date_range_end'
        db.alter_column('calfire_tracker_wildfireannualreview', 'date_range_end', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'WildfireAnnualReview.data_source'
        db.delete_column('calfire_tracker_wildfireannualreview', 'data_source')


        # Changing field 'WildfireAnnualReview.date_range_beginning'
        db.alter_column('calfire_tracker_wildfireannualreview', 'date_range_beginning', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'WildfireAnnualReview.date_range_end'
        db.alter_column('calfire_tracker_wildfireannualreview', 'date_range_end', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
