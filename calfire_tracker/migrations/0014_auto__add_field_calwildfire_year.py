...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.year'
        db.add_column('calfire_tracker_calwildfire', 'year',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.year'
        db.delete_column('calfire_tracker_calwildfire', 'year')
