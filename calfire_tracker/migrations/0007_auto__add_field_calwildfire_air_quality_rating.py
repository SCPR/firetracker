...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.air_quality_rating'
        db.add_column('calfire_tracker_calwildfire', 'air_quality_rating',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.air_quality_rating'
        db.delete_column('calfire_tracker_calwildfire', 'air_quality_rating')
