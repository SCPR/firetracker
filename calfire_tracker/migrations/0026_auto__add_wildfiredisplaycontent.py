...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WildfireDisplayContent'
        db.create_table('calfire_tracker_wildfiredisplaycontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_headline', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('content_link', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True)),
            ('last_saved', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('calfire_tracker', ['WildfireDisplayContent'])


    def backwards(self, orm):
        # Deleting model 'WildfireDisplayContent'
        db.delete_table('calfire_tracker_wildfiredisplaycontent')
