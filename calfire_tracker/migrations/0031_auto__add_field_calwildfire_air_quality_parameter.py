...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalWildfire.air_quality_parameter'
        db.add_column('calfire_tracker_calwildfire', 'air_quality_parameter',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalWildfire.air_quality_parameter'
        db.delete_column('calfire_tracker_calwildfire', 'air_quality_parameter')
