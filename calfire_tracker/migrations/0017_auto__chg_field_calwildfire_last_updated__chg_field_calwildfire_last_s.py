...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalWildfire.last_updated'
        db.alter_column('calfire_tracker_calwildfire', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CalWildfire.last_scraped'
        db.alter_column('calfire_tracker_calwildfire', 'last_scraped', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'CalWildfire.last_updated'
        db.alter_column('calfire_tracker_calwildfire', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'CalWildfire.last_scraped'
        db.alter_column('calfire_tracker_calwildfire', 'last_scraped', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        'calfire_tracker.calwildfire': {
            ...
            'last_scraped': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
