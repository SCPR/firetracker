...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WildfireSource'
        db.create_table('calfire_tracker_wildfiresource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('source_short', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('source_slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True)),
            ('source_url', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True)),
            ('source_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parent_tag', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('parent_attrib', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('parent_selector', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('target_tag', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('target_attrib', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('target_selector', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('extraction_type', self.gf('django.db.models.fields.CharField')(default='Simple Scrape', max_length=255)),
            ('target_index', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('calfire_tracker', ['WildfireSource'])


    def backwards(self, orm):
        # Deleting model 'WildfireSource'
        db.delete_table('calfire_tracker_wildfiresource')
    ...
    models = {
        ...
        'calfire_tracker.wildfiresource': {
            ...
            'source_short': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
